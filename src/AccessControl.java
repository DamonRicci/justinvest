...
/**
 * Centralized permission evaluator mapping roles to permissions and enforcing contextual checks.
 */
public class AccessControl {
    ...
    /**
     * Determines whether the given user can perform the requested permission in the provided context.
     */
