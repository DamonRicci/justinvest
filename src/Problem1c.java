...
/**
 * Basic permission checks across roles loaded from users.txt.
 */
public class Problem1c {
    ...
    private static Map<String, User> loadUsers(String path) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(path, StandardCharsets.UTF_8))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // Support either single role or comma-separated labels; take first as "role"
    ...
    private static String normalizeRole(String roleToken) {
        // Handles "Client", "Premium Client", "PREMIUM_CLIENT", "financial-advisor", etc.
    ...
    private static User requireUser(Map<String, User> users, String username) {
        ...
        if (u == null) throw new IllegalStateException("Missing user in users.txt: " + username);
        return u;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Pull users from users.txt (update these usernames to match your users.txt)
        ...
        // 3. Portfolio modification by employees
